...
--  VAT  | Holy See (Vatican City State) | Europe    | Southern Europe |         0.4 |      1929 |       1000 |                |       9.00 |            | Sant
...
-- Write SQL query here
--  SMR         | Italian  | t          |        100
SELECT * FROM countrylanguages WHERE language = 'Italian' AND percentage='100.0';
